...
class PortfolioAnalysis(FormulatorAbstract):
    ...
    def calculate(self, df):
        ...
        for index,company in enumerate(list_companies):
            ...
            optimal_weights.append(optimal)
            minimal_weights.append(minimal)
        ...
        log_returns['equal_returns'] = log_returns[list_companies].dot(equal_weights)
        ...
        rolling_volatility = (log_returns.rolling(42).std() * np.sqrt(42)).dropna(axis=0, how='any')
